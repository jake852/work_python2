...
'''
# 리스트 
sentences = ["I am quitting this exam.", "This is the quickest approach I ever seen", "The king should make quick decision"]
...
'''
    ...
    - for문을 이용하여 1부터 1000000까지의 숫자중에서 3의 배수인 숫자들을 찾고,
    몇개가 있는지 알아보자.
